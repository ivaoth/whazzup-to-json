<?php
  ...
  foreach($c_data as $dat)
  {
    ...
    $c_dat=explode(':', $dat);
    //echo $c_dat[3].'<br>';
    if(($c_dat[3]=='PILOT' || $c_dat[3]=='FOLME') && $c_dat[20] != '' && (substr($c_dat[11], 0, strlen('VTBD'))==='VTBD' || substr($c_dat[13], 0, strlen('VTBD'))==='VTBD')) {
    ...
    else if($c_dat[3]=='ATC' && $c_dat[4]!=null && substr($c_dat[0], 0, strlen('VTBD'))==='VTBD') {
      $res_a[$i_a]=array(
        'callsign' => $c_dat[0],
        'vid' => $c_dat[1],
        'name' => $c_dat[2],
